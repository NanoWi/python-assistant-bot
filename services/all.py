...
def get_media_id(media_name , media_type):
    ...
    #    media_id = config.images.get(media_name, None)
    #elif media_type == "video":
    #    media_id = config.videos.get(media_name, None)
    #elif media_type == "audio":
    #    media_id = config.audio.get(media_name, None)
    return media_id
...
def administrar_chatbot(text,number, messageId, name):
    ...
    if "hola" in text:
        ...
        document = document_Message(number, config.document_url, "Listo 👍🏻", "Inteligencia de Negocio.pdf")
